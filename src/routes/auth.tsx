...
function AuthPage() {
  ...
  async function guest() { setBusy(true); setMessage(""); const { error } = await supabase.auth.signInAnonymously(); setBusy(false); if (error) setMessage(error.message); else window.location.href = "/onboarding"; }
